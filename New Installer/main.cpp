...
static TCHAR szWindowClass[] = _T("TBCPPLGInstaller");//make this your own

// The string that appears in the application's title bar.
static TCHAR szTitle[] = _T("TBCP Plugin Installer v2.00");//make this your own
...
{
    //edit this stuff
    std::string TIDJPN = "000400000015DA00";
    std::string TIDUSA = "000400000018BC00";
    std::string TIDEUR = "000400000018F500";
    std::string TIDCHN = "";
    std::string TIDKOR = "000400000018B500";
    std::string TIDTWN = "";
    LPCTSTR PluginLink = TEXT("https://github.com/FoofooTheGuy/Battle-Cats-Pop-The.-3DS-Plugin/releases/latest/download/Battle-Cats-Plugin.3gx");
    LPCTSTR PluginFile = TEXT("Battle-Cats-Plugin.3gx");
    std::string PluginFileString = "Battle-Cats-Plugin.3gx";
    LPCTSTR BootFirmLink = TEXT("https://github.com/FoofooTheGuy/Battle-Cats-Pop-The.-3DS-Plugin/raw/main/boot.firm");
    ...
    case WM_CREATE:
        case 0:
        {
            item1 = CreateWindow(TEXT("BUTTON"), TEXT("Install!"), WS_VISIBLE | WS_CHILD | WS_BORDER, 15, 205, 450, 30, hwnd, (HMENU)1, NULL, NULL);
            if (detect3dsSd() != "") {
            ...
            item2 = CreateWindowEx(0, PROGRESS_CLASS, TEXT(""), WS_CHILD | WS_VISIBLE, 15, 240, 450, 30, hwnd, (HMENU)ID_DEFAULTPROGRESSCTRL, ((LPCREATESTRUCT)lParam)->hInstance, NULL);
            //region buttons, note some out if you dont need some
            ...
            item7 = CreateWindow(TEXT("BUTTON"), TEXT("KOR"), WS_VISIBLE | WS_CHILD | WS_BORDER | BS_CHECKBOX, 20, 150, 185, 35, hwnd, (HMENU)6, ((LPCREATESTRUCT)lParam)->hInstance, NULL);
            ...
            item13 = CreateWindow(TEXT("STATIC"), TEXT("Choose options, then click \"Install!\" when you're ready."), WS_VISIBLE | WS_CHILD | WS_BORDER, 20, 277, 440, 30, hwnd, NULL, NULL, NULL);
        }
        break;
    case WM_COMMAND:
        switch (LOWORD(wParam)) {
            case 1://Install!
            {
                ...
                disableAll();
                SendMessage(item13, WM_SETTEXT, 0, (LPARAM)TEXT("Downloading Battle-Cats-Plugin.3gx..."));//you may want to change this
                ...
                SendMessage(item13, WM_SETTEXT, 0, (LPARAM)TEXT("Installation complete!"));
                    ...
                    switch (choice) {
                    case IDYES: system("start \"\" https://github.com/FoofooTheGuy/Battle-Cats-Pop-The.-3DS-Plugin#method-1-assisted-installation-using-a-windows-pc");//change this as well
                        break;
                    default:
                        break;
                    }
